 ...
 */
?><!DOCTYPE html>
<html <?php language_attributes(); ?> class=" requestanimationframe raf svg video inputsearchevent checked placeholder texttrackapi track history no-webanimations json classlist cssanimations flexbox smil canvas">
<head>
  <meta charset="<?php bloginfo( 'charset' ); ?>">
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
  <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">
  <meta name="keywords" content="ecommerce fraud detection resources webinar infographic">
  <meta name="description" content="Learn about online fraud and machine learning with these ebooks, videos, and tutorials.">
			...
			<div class="banner-container">
  			<!-- <div class="headline"> -->
			    ...
			    <?php
						...
						<div id="header-right">
								<img id="blog-lady" src="http://localhost:8888/siftscience/wp-content/themes/siftscience/images/blog-lady.svg" alt="Sift Scientist Woman" />
						</div>
							<?php else : ?>
							<h1>Category</h1>
						<?php endif;
