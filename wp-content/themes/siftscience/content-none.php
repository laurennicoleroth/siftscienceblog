...
<section class="hentry no-results not-found">
	...
	<div class="entry-content">
		...
		<?php elseif ( is_search() ) : ?>
			...
			<p><?php _e( 'Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'siftscience' ); ?></p>
			<?php get_search_form(); ?>

		<?php else : ?>

			<p><?php _e( 'It seems we can&rsquo;t find what you&rsquo;re looking for. Perhaps searching can help.', 'siftscience' ); ?></p>
			<?php get_search_form(); ?>
