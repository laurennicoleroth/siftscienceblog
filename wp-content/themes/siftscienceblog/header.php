...
?><!DOCTYPE html>
<html class=" requestanimationframe raf svg video inputsearchevent checked placeholder texttrackapi track history no-webanimations json classlist cssanimations flexbox smil canvas">
<head>
    ...
    <div class="sift-edu sift-edu-sublanding resources-page">
    	<header class="light">
    		<a href="/" class="sift-brand">
    			<svg class="color-logo"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#icon-color-logo"></use></svg>
    			<svg class="color-hexagon"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#icon-color-hexagon"></use></svg>
    			<svg class="monochrome-logo"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#icon-monochrome-logo"></use></svg>
    			<svg class="monochrome-hexagon"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#icon-monochrome-hexagon"></use></svg>
    		</a>
    		...
    		<div class="utility-nav">
    			...
    			<div class="veggieburger-wrap">
    				<svg class="veggieburger"><rect y="0" width="24" height="4"></rect><rect y="8" width="24" height="4"></rect><rect y="16" width="24" height="4"></rect></svg>
    			</div>
    		</div>
